		...
		<div class="clear"></div>
			...
			<li>API: <span style="color:#2276BB"><?php $r=getTwitter()->ratelimit();echo $r->remaining_hits; ?>/<?php echo $r->hourly_limit; ?></span></li>
			...
			<?php if (STAT_IMG) {?><img src="<?php echo STAT_IMG ?>" stlyle="display:none"/><?php }?>
			</ul>
			</div>
		</div>
	</div>
